      ...
      <div class="d-flex" id="wrapper" data-aos="fade-right">
        ...
        <div class="border-right" id="sidebar-wrapper">
          <div class="sidebar-heading text-center">
            <img height="60px" src="/images/LOGO6.png" alt="" class="my-4" />
          </div>
          <div class="list-group list-group-flush">
            ...
            <a
              ...
              class="list-group-item list-group-item-action <?php echo e((request()->is('admin/transactions*')) ? 'active' : ''); ?>"
              >Transactions</a
            >

            <a
              href="<?php echo e(route('troubleshoot-article.index')); ?>"
              class="list-group-item list-group-item-action <?php echo e((request()->is('admin/troubleshoot-article*')) ? 'active' : ''); ?>"
              >Articles</a
            >
            <a
              href="<?php echo e(route('troubleshoot-gallery-article.index')); ?>"
              class="list-group-item list-group-item-action <?php echo e((request()->is('admin/troubleshoot-gallery-article*')) ? 'active' : ''); ?>"
              >Article Galleries</a
            >
            <a
              href="<?php echo e(route('troubleshoot-category.index')); ?>"
              class="list-group-item list-group-item-action <?php echo e((request()->is('admin/troubleshoot-category*')) ? 'active' : ''); ?>"
...
<?php /**PATH C:\laragon\www\laboran\resources\views/layouts/admin.blade.php ENDPATH**/ ?>